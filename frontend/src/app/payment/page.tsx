...
export default function Payment() {
  return (
    <div className="py-6 px-4 md:px-6 2xl:px-10 2xl:container 2xl:mx-auto bg-gray-100">
      ...
      <div className="mt-10 flex flex-col jusitfy-center items-stretch w-full space-y-4 md:space-y-6 xl:space-y-6">
        ...
        <div className="bg-gray-50 mt-10 dark:bg-gray-800 w-full xl:w-full flex justify-between items-center md:items-start px-4 py-6 md:p-6 xl:p-8 flex-col">
        ...
        <div className="flex justify-end bg-gray-50 mt-0 p-5">
          <button className="btn btn-primary md:btn-wide w-full">Pay</button>
        </div>
      </div>
    </div>
  );
